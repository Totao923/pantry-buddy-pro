...
import BarcodeItemConfirm, { ConfirmedBarcodeItem } from './BarcodeItemConfirm';

interface BarcodeScannerProps {
  onProductFound: (confirmedData: ConfirmedBarcodeItem) => void;
  onClose: () => void;
}
...
export default function BarcodeScanner({ onProductFound, onClose }: BarcodeScannerProps) {
  ...
  const handleConfirmProduct = (confirmedData: ConfirmedBarcodeItem) => {
    setShowConfirmModal(false);
    onProductFound(confirmedData);
  };
