          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-lg">
                Upgrade to Cloud Storage Available!
              </h3>
          ...
          <div className="mt-4 p-3 bg-red-500/20 border border-red-300/30 rounded-lg">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">
                Migration failed: {migrationState.error}
              </span>
            </div>
          </div>
        )}
              ...
              <div>
                ...
                <div className="mt-4 p-3 bg-white/10 rounded-lg">
                  <p className="text-xs text-blue-100">
                    <strong>Safe & Secure:</strong> Your original data remains untouched during migration. 
