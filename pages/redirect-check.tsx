...
export default function RedirectCheck() {
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'monospace' }}>
      ...
      <p>If the dashboard doesn't load within 3 seconds, you'll be redirected to the working deployment.</p>
      <p>Current URL: <code>{typeof window !== 'undefined' ? window.location.hostname : 'Loading...'}</code></p>
    </div>
  );
}