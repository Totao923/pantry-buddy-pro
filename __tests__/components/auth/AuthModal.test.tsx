...
describe('AuthModal Component', () => {
  ...
  it('renders signup mode when initialMode is signup', () => {
    ...
    expect(screen.getAllByText(/create account/i)).toHaveLength(2); // Header and button
  ...
  it('handles signup form submission', async () => {
    ...
    await waitFor(() => {
      expect(mockAuthMethods.signUp).toHaveBeenCalledWith('test@example.com', 'password123', { name: 'John Doe' });
    });
  });
