export const STRIPE_PRODUCT_DESCRIPTIONS = {
  premium:
    'Unlock advanced meal planning with AI-powered recipe suggestions, unlimited pantry tracking, and personalized nutrition insights. Perfect for home cooks ready to elevate their kitchen game.',

  family:
    'Everything in Premium plus family meal planning for up to 6 members, dietary restriction management, bulk recipe scaling, and collaborative shopping lists. Ideal for busy families.',
