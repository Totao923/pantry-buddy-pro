    ...
    return [
      // Italian
      {
        ...
        instructions: [
          ...
          {
            step: 2,
            instruction: 'Prepare vegetables by cutting into uniform pieces',
            duration: 10,
          },
          {
            step: 3,
            instruction: 'Cook pasta according to package directions until al dente',
            duration: 12,
          },
          {
            step: 4,
            instruction: 'Heat olive oil in large skillet and sauté garlic until fragrant',
            duration: 2,
          },
      ...
      // Asian
      {
        ...
        instructions: [
          {
            step: 1,
            instruction: 'Cut all ingredients into uniform sizes for even cooking',
            duration: 10,
          },
          {
            step: 2,
            instruction: 'Heat wok or large skillet over high heat until smoking',
            duration: 2,
          },
          {
            step: 3,
            instruction: 'Add oil and immediately add protein, stir-fry until nearly cooked',
            duration: 4,
          },
          {
            step: 4,
            instruction: 'Push protein to one side, add aromatics to empty space',
            duration: 1,
          },
      ...
      // Mexican
      {
        ...
        instructions: [
          {
            step: 1,
            instruction: 'Season protein with cumin, paprika, and chili powder',
            duration: 5,
          },
          { step: 2, instruction: 'Cook rice with a bay leaf and salt until tender', duration: 18 },
          {
            step: 3,
            instruction: 'Heat skillet and cook protein until golden and cooked through',
            duration: 8,
          },
          {
            step: 4,
            instruction: 'Warm beans with garlic and a splash of lime juice',
            duration: 5,
          },
          { step: 5, instruction: 'Quickly sauté vegetables until crisp-tender', duration: 6 },
          {
            step: 6,
            instruction: 'Assemble bowl with rice, beans, protein, and vegetables',
            duration: 2,
          },
      ...
      // Mediterranean
      {
        ...
        instructions: [
          {
            step: 1,
            instruction: 'Marinate protein with olive oil, lemon, and herbs',
            duration: 10,
          },
